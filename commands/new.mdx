---
title: "acton new — create a new TON smart contract project"
sidebarTitle: "new"
...
<Tabs>
  ...
  <Tab title="w5-extension">
    ...
    deploy/install/delete scripts. Also accepts the alias `w5-plugin`.
  </Tab>
</Tabs>
...
<Note>
  ...
  `nft-app` template names — use `--template counter --app` (etc.) instead.
</Note>
