---
title: "acton check — lint and fix Tolk smart contract sources"
sidebarTitle: "check"
description: "Lint Tolk contracts with acton check. Covers --fix, --output-format (plain/json/sarif/github/gitlab), --enable-only, --output-file, and CI annotations."
---
