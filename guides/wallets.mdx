---
title: "Managing Wallets for TON Contract Deployment"
sidebarTitle: "Wallets"
description: "Create, import, fund, and use wallets with acton wallet: local vs global storage, wallet versions, wallets.toml config, testnet airdrop, and security best practices."
---
...
If `--name` or `--version` is omitted, Acton prompts interactively. The most common wallet versions are:
