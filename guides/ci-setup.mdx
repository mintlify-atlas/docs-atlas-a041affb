---
title: "Setting Up CI for Acton TON Contract Projects"
sidebarTitle: "CI Setup"
description: "Install Acton in GitHub Actions or GitLab CI, run build, test, lint, and format checks, upload SARIF or JUnit reports, and securely store wallet mnemonics in CI secrets."
---
