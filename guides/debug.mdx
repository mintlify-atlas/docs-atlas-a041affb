...
sidebarTitle: "Debug"
description: "Set breakpoints in Tolk, step through contract execution, inspect TVM registers and locals using acton test --debug or acton script --debug and the DAP protocol."
---
...
The default debug port is `4711`. Override it with `--debug-port`:
