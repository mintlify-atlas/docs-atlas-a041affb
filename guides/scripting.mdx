---
title: "Running Tolk Scripts for Blockchain Interaction"
sidebarTitle: "Scripting"
description: "Write and run standalone Tolk scripts with acton script: wallet access, net.send(), argument passing, local emulation vs network broadcast, and deploy examples."
---
