---
title: "Building TON Contracts with the Acton Build System"
sidebarTitle: "Building"
description: "Compile Tolk smart contracts with acton build: single vs all contracts, output dirs, build cache, dependency kinds, and wrapper generation."
---
