---
title: "Format Tolk Contracts with acton fmt – Acton Guide"
sidebarTitle: "Format"
description: "Use acton fmt to auto-format Tolk source files, validate style in CI with --check, pipe source via --stdin for editor integration, and set ignore patterns."
---
