---
title: "Acton.toml Complete Configuration Reference"
sidebarTitle: "Acton.toml"
description: "Full reference for every section and field in Acton.toml: package, toolchain, contracts, build, test, lint, fmt, localnet, scripts, import-mappings, and networks."
---
...
| Field | Type | Default | Description |
|:------|:-----|:--------|:------------|
| `output-dir` | string | `wrappers/` | Default directory for generated Tolk wrappers. |
