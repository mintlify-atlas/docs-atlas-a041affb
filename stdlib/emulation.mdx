...
description: "Full reference for @acton/emulation/* modules — blockchain emulation, message sending, wallet integration, and config control."
---
...
get fun `test zero-gas environment`() {
    ...
    Assert.equal(ok, true, "config update failed");
